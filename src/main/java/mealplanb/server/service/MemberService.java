...
//     * 남은 칼로리 계산
//     */
//    public int calculateRemainingKcal(int targetKcal, List<Meal> meals) {
//        int totalMealKcal = 0;
//        for (Meal meal : meals) {
//            totalMealKcal += (int)foodMealMappingTableService.getMealKcal(meal.getMealId());
//        }
//        return targetKcal - totalMealKcal;
//    }
