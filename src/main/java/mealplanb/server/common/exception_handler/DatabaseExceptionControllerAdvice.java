...
import static mealplanb.server.common.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static mealplanb.server.common.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
